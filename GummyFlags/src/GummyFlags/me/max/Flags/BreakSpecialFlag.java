...
public class BreakSpecialFlag extends StateFlag{
	 public static BreakSpecialFlag flag = new BreakSpecialFlag();

	    public BreakSpecialFlag() {
	        super("BreakSpecial", false);
	    }
